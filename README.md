...
## Structure du dépôt
* `TP3---LOG3000-main/` : code source de l'application.
...
Cloner le dépôt :
```bash
git clone https://github.com/Alfred23sss/TP3_LOG3000.git
```
...
## Guide d'utilisation
Lancer l'application Flask depuis `TP3---LOG3000-main` :
```bash
python app.py
```
...
## Guide de test
Depuis `TP3---LOG3000-main` avec l'environnement virtuel activé :
...
```
Voir `TP3---LOG3000-main/tests/README.md` pour les détails de couverture de test.

## Flux de contribution
* Créer ou confirmer un problème (issue) GitHub décrivant le bogue/la fonctionnalité.
* Créer une branche dédiée à partir de `main` : `fix/issue-<id>-short-description`
